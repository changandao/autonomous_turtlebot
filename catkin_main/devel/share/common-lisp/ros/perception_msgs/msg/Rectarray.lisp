...
(cl:defmethod cl:initialize-instance :after ((m <Rectarray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Rectarray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name perception_msgs-msg:<Rectarray> is deprecated: use perception_msgs-msg:Rectarray instead.")))
...
(cl:defmethod id-val ((m <Rectarray>))
...
(cl:defmethod x-val ((m <Rectarray>))
...
(cl:defmethod y-val ((m <Rectarray>))
...
(cl:defmethod height-val ((m <Rectarray>))
...
(cl:defmethod width-val ((m <Rectarray>))
