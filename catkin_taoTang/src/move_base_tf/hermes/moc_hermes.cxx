...
static const char qt_meta_stringdata_Hermes[] = {
    "Hermes\0"
};
...
const QMetaObjectExtraData Hermes::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Hermes::staticMetaObject = {
    { &QTcpSocket::staticMetaObject, qt_meta_stringdata_Hermes,
      qt_meta_data_Hermes, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Hermes::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Hermes))
