...
if("FALSE" STREQUAL "TRUE")
  set(simple_navigation_goals_SOURCE_PREFIX /nas/ei/home/ga62gis/gruppe3/workspace/src/simple_navigation_goals)
  set(simple_navigation_goals_DEVEL_PREFIX /nas/ei/home/ga62gis/gruppe3/workspace/devel)
  ...
  set(simple_navigation_goals_INSTALL_PREFIX /nas/ei/home/ga62gis/gruppe3/workspace/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'quxingwei <quxingwei@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'simple_navigation_goals' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/nas/ei/home/ga62gis/gruppe3/workspace/install/${idir}'.  ${_report}")
    endif()
